...
#ifndef MESHCOREKIT_SWIFT_H
#define MESHCOREKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MeshCoreKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11MeshCoreKit10BLEManager")
...
@interface BLEManager (SWIFT_EXTENSION(MeshCoreKit)) <CBPeripheralDelegate>
...
@class NSString;
@class NSNumber;
@interface BLEManager (SWIFT_EXTENSION(MeshCoreKit)) <CBCentralManagerDelegate>
