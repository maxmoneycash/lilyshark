...
(function (global) {
    ...
    function navBar(ctx, y, title, options) {
        ...
        // iOS 6 glass: hard equator in the upper third, not a mid fade.
        ...
        shine.addColorStop(0.62, "rgba(255,255,255,0.16)");
    ...
    function sendButton(ctx, x, y, width, height, label, action, colors) {
        ...
        text(ctx, label, x + width / 2, y + Math.round((height - 10) / 2), C.White, {
            ...
            weight: "700",
            align: "center",
            shadow: idle ? "rgba(0,0,0,0.28)" : "rgba(0,0,0,0.62)",
            shadowY: 1,
        });
        if (action) hit(x, y, width, height, action);
    }
    ...
    function balloonPath(ctx, x, y, width, height, mine, radius) {
        ...
        if (mine) {
            ...
            ctx.quadraticCurveTo(x + width + 1.2, y + height + 0.3, x + width + 4.6, y + height + 2.8);
            ctx.quadraticCurveTo(x + width + 1.2, y + height + 1.3, x + width - 3.8, y + height);
            ...
            ctx.lineTo(x + 3.8, y + height);
            ctx.quadraticCurveTo(x - 1.2, y + height + 1.3, x - 4.6, y + height + 2.8);
            ctx.quadraticCurveTo(x - 1.2, y + height + 0.3, x, y + height - 2.8);
            ctx.lineTo(x, y + r);
            ctx.quadraticCurveTo(x, y, x + r, y);
        }
        ctx.closePath();
    ...
    function composeButton(ctx, x, y, action) {
        ...
        // iOS 6 compose: white notepad with lines, yellow pencil across.
        panel(ctx, x + 4.5, y + 2.6, 12.2, 13.0, C.White, 0xe6e8ee, 0x2b486b, 1.6);
        ctx.fillStyle = "rgba(255,255,255,0.92)";
        ctx.fillRect(x + 5.5, y + 3.4, 10.2, 1);
        ctx.strokeStyle = hex24(0x7a90a8);
        ctx.lineWidth = 1;
        ctx.lineCap = "round";
        ctx.beginPath();
        ctx.moveTo(x + 6.4, y + 6.6);
        ctx.lineTo(x + 14.4, y + 6.6);
        ctx.moveTo(x + 6.4, y + 9.2);
        ctx.lineTo(x + 13.8, y + 9.2);
        ctx.moveTo(x + 6.4, y + 11.8);
        ctx.lineTo(x + 12.6, y + 11.8);
        ctx.stroke();
        ctx.save();
        ctx.lineCap = "round";
        ctx.strokeStyle = "rgba(255,255,255,0.70)";
        ctx.lineWidth = 2.6;
        ctx.beginPath();
        ctx.moveTo(x + 16.2, y + 13.6);
        ctx.lineTo(x + 24.0, y + 5.4);
        ctx.stroke();
        ctx.strokeStyle = hex24(0x2e4a72);
        ctx.lineWidth = 1.45;
        ctx.beginPath();
        ctx.moveTo(x + 16.4, y + 13.4);
        ctx.lineTo(x + 23.2, y + 6.2);
        ctx.stroke();
        ctx.restore();
        ctx.fillStyle = hex24(0xf4c44a);
        ctx.beginPath();
        ctx.moveTo(x + 22.4, y + 3.8);
        ctx.lineTo(x + 26.2, y + 6.6);
        ctx.lineTo(x + 23.8, y + 7.6);
        ctx.closePath();
        ctx.fill();
        ctx.fillStyle = hex24(0x1c2228);
        ctx.beginPath();
        ctx.moveTo(x + 25.2, y + 4.4);
        ctx.lineTo(x + 26.8, y + 5.6);
        ctx.lineTo(x + 25.4, y + 6.4);
        ctx.closePath();
        ctx.fill();
    }
