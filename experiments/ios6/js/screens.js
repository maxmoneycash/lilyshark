(function (global) {
    ...
    function drawMessagesInbox(ctx) {
        ...
        searchBar.addColorStop(0, "#c8cad2");
        searchBar.addColorStop(1, "#8a8c94");
        ...
        ctx.clip();
        const inset = ctx.createLinearGradient(0, searchY + 4, 0, searchY + 13);
        inset.addColorStop(0, "rgba(0,0,0,0.42)");
        inset.addColorStop(0.55, "rgba(0,0,0,0.10)");
        inset.addColorStop(1, "rgba(0,0,0,0)");
        ctx.fillStyle = inset;
        ctx.fillRect(8, searchY + 4, 304, 13);
