 ...
 * columns the frame table shows, RFC 4180 throughout: CRLF line endings, a
 ...
 * shared set, plus `note` only when the caller supplied annotations — an
 * export without them is byte-identical to what this always wrote.
 */
