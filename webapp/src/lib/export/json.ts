 ...
 *
 * An export given annotations carries one more key, `note`, on every object
 * — null on a frame that has none. Without annotations the key is absent
 * everywhere, so an un-annotated document is unchanged.
 */
